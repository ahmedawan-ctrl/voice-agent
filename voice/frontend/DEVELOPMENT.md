...
```bash
git remote add encore encore://voice-agent-landing-3972
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/voice-agent-landing-3972/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/voice-agent-landing-3972/settings/integrations/github)
